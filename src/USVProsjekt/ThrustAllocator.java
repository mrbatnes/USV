...
public class ThrustAllocator {
    ...
    public ThrustAllocator() {
        ...
        setup(0d, 1.5d, -.5d, -.5d, .5d, -.5d, new double[]{100d, 100d, 1000d});
    }
    ...
    public double[] calculateOutput(double[] tau, boolean travelMode) throws Exception {
        ...
        if (returnCode == OptimizationResponse.FAILED) {
            ...
            return this.getThrustAndAnglesDeg(opt.getOptimizationResponse().getSolution());
        }
...
/*
     ...
     */
    private double[] getThrustAndAnglesRad(double[] r, boolean travelMode) {
        ...
        if(travelMode){
            return new double[]{u1, 0d, u2, phi2, u3, phi3};
        } else {
