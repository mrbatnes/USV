...
public class Application extends Thread {
    ...
    public void run() {
        ...
        while (guiCommand != 4) {
            ...
            if (server.isHornLanternReceived()) {
                thrustWriter.writeHornLanternCommand(server.getHornLanternCommand());
            }
...
//                + " Y: " + remoteCommand[1] + " Heading: " + remoteCommand[2]);
    ...
    private void autonomousTravel() {
        ...
        if (!travelStarted && server.isRouteReceived()) {
            ...
            timer = new Timer();
            timer.scheduleAtFixedRate(autonomousTravel, 10, 300);
            travelStarted = true;
    ...
    public void initializeApplication() {
        ...
        currentPositionStorageBox = new GPSCurrentPositionStorageBox();
        gps = new GPSreader(Identifier.GPS, northEastPositionStorage, currentPositionStorageBox);
