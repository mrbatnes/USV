...
public class SerialConnection {
    ...
    public void writeHornLantern(String send){
        PrintWriter output = new PrintWriter(comPort.getOutputStream());
        output.write(send);
        output.flush();
    }
    ...
    public void getPosition() {
        PrintWriter output = new PrintWriter(comPort.getOutputStream());
        output.write(getWriteString(null, Identifier.REQUEST_ROTATION_POS));
        output.flush();
    }

    public String getWriteString(int[] in, Identifier ID) {
